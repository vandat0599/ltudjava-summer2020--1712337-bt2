...
CREATE TABLE IF NOT EXISTS `student_manager`.`PhucKhao` (
  ...
  `tinhTrang` VARCHAR(45) NULL DEFAULT 'ChÆ°a xem',
...
CREATE TABLE IF NOT EXISTS `student_manager`.`PhucKhaoDiem` (
  ...
  `hoTen` VARCHAR(45) NULL DEFAULT NULL,
  `maMonHoc` VARCHAR(45) NOT NULL,
  `cotDiem` VARCHAR(45) NULL DEFAULT NULL,
  `diemMongMuon` FLOAT NULL DEFAULT NULL,
  `lyDo` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`mssv`),
